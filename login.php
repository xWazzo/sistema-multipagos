        ...
        <div class="login login-with-news-feed">
            ...
            <div class="news-feed">
                <div class="news-image">
                    <img src="assets/img/login-bg/bg-9.jpg" data-id="login-cover-image" alt="" />
                </div>
                <div class="news-caption">
                    <h4 class="caption-title"><i class="fa fa-diamond text-success"></i> Sistema de Juegos y Ventas</h4>
                    <p>
                ...
                <div class="login-content">
                    <form action="index.html" method="POST" class="margin-bottom-0">
                        ...
                        <div class="login-buttons">
                            <a href="index.php" class="btn btn-success btn-block btn-lg">Ingresar</a>
                        </div>
                        <div class="m-t-20">
                            ¿No recuerdas tu contraseña? <a href="register_v3.html" class="text-success">clic aquí</a>.
                            <center><img class="m-t-20" src="assets/img/asgar-mini-logo.png" width="80px"></center>
                        </div>
                        <hr />
